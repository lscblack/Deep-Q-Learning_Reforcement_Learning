...
def main():
    ...
    experiments_config = [
        # 1. THE INSTANT REFLEX (MLP)
        {'focus': 'Micro Sprint 1', 'policy': 'MlpPolicy', 'timesteps': 10000,
        ...
        # 2. THE RAPID BATCH (MLP)
        {'focus': 'Micro Sprint 2', 'policy': 'MlpPolicy', 'timesteps': 15000,
        ...
        # 3. THE STANDARD SPRINT (MLP)
        {'focus': 'Micro Sprint 3', 'policy': 'MlpPolicy', 'timesteps': 20000,
        ...
        # 7. THE WIDE BATCH (MLP)
        {'focus': 'Micro Sprint 7', 'policy': 'MlpPolicy', 'timesteps': 40000,
        ...
        # 8. THE DEEP MEMORY (MLP)
        {'focus': 'Micro Sprint 8', 'policy': 'MlpPolicy', 'timesteps': 55000,
        ...
        # 9. THE FUTURE LOOKER (High Gamma, CNN stays)
        {'focus': 'Micro Sprint 9', 'policy': 'CnnPolicy', 'timesteps': 99000,
        'lr': 2.0e-4, 'gamma': 0.98, 'batch_size': 512, 'buffer_size': 25000,
        'learning_starts': 5000, 'target_update': 2000,
        'epsilon_start': 1.0, 'epsilon_end': 0.02, 'epsilon_decay': 0.1},

        # 10. THE MINI-CHAMP (MLP)
        {'focus': 'Micro Sprint 10', 'policy': 'MlpPolicy', 'timesteps': 70000,
        'lr': 1.0e-4, 'gamma': 0.99, 'batch_size': 256, 'buffer_size': 30000,
